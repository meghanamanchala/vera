...
BOT_URL = "https://vera-6wrd.onrender.com"

# Choose your LLM provider: "openai", "anthropic", "gemini", "deepseek", "groq", "ollama", "openrouter"
LLM_PROVIDER = "gemini"

# Your API key (paste your key here)
LLM_API_KEY = ""  # <-- Empty to load from .env or environment variable
...
def main():
    ...
    if LLM_PROVIDER != "ollama" and not LLM_API_KEY:
        ...
        print_info("Edit the CONFIGURATION section at the top of this file or set GEMINI_API_KEY/OPENAI_API_KEY in your environment.")
